...
// Exit if accessed directly
                        ...
                        <?php
                            ...
                            <div class="bdt-offcanvas-custom-content-after widget">
                                <div class="bdt-alert-warning"
                                     bdt-alert><?php
                                        esc_html_e( 'Ops you don\'t select or enter any content! Add your offcanvas content from editor.', 'bdthemes-prime-slider' ); ?></div>
                            </div>
                        <?php
                        endif; ?>
                </div>
					...
					<span <?php
                        ...
                        <?php
                            if ( !empty( $settings['offcanvas_button_text'] ) ): ?>
                                <span <?php
                                    $this->print_render_attribute_string( 'text' ); ?>><?php
                                        echo esc_html( $settings['offcanvas_button_text'] ); ?></span>
                            <?php
                            endif; ?>
					</span>
    ...
    <?php
        ...
        public function render_social_link($position = 'left', $label = false, $class = []) {
            ...
            <div <?php
                ...
                <?php
                    if ( $label ): ?>
                        <h3><?php
                                esc_html_e( 'Follow Us', 'bdthemes-prime-slider' ); ?></h3>
                    <?php
                    endif; ?>
                    ...
                    foreach ( $settings['social_link_list'] as $link ):
                        ...
                        <a href="<?php
                           ...
                           target="_blank" <?php
                            ...
                            <?php
                                Icons_Manager::render_icon( $link['social_icon'], ['aria-hidden' => 'true', 'class' => 'fa-fw'] ); ?>
                        </a>
                    <?php
                    endforeach; ?>
            </div>
        ...
        public function render_scroll_button_text() {
            ...
            <span <?php
                $this->print_render_attribute_string( 'text' ); ?>><?php
                    echo esc_html( $settings['scroll_button_text'] ); ?></span>
        </span>
            <?php
        }
        ...
        public function render_button($post) {
            ...
            if ( 'yes' == $settings['show_button_text'] ): ?>
                ...
                <a <?php
					...
					<span <?php
                        $this->print_render_attribute_string( 'text' ); ?>><?php
                            echo esc_html( $settings['button_text'] ); ?><span
                    ...
                    <div class="bdt-child-width-1-1 bdt-child-width-1-3@s bdt-grid-collapse" bdt-grid>
                        ...
                        <div class="bdt-ps-meta-item bdt-flex bdt-flex-middle"
                            ...
                            <div class="bdt-meta-text">
                                ...
                                esc_html_e( 'Written by', 'bdthemes-prime-slider' ); ?><br> 
                        ...
                        <div class="bdt-ps-meta-item bdt-flex bdt-flex-middle bdt-visible@s"
                            ...
                            <div class="bdt-meta-text">
                                            <span>
                                            <?php
                                                esc_html_e( 'Published on', 'bdthemes-prime-slider' ); ?> <br> <?php
                                                    echo get_the_date(); ?>
                                            </span>
                            </div>
                        </div>
                ...
                <li class="bdt-slideshow-item bdt-flex bdt-flex-middle bdt-flex-center elementor-repeater-item-<?php
                    ...
                    <div
                            class="bdt-position-cover bdt-animation-kenburns<?php
                                echo esc_attr( $kenburns_reverse ); ?> bdt-transform-origin-center-left">
                        <?php
                            endif; ?>
