<?php
namespace PrimeSlider\Modules\EventCalendar\Widgets;
...
class Event_Calendar extends Widget_Base {
	...
	public function _register_controls() {
		...
		$this->add_control(
			'show_title',
			[
				'label'   => __( 'Show Title', 'bdthemes-prime-slider' ),
		...
		$this->add_control(
			'show_excerpt',
			[
				'label'   => __( 'Show Excerpt', 'bdthemes-prime-slider' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-event-calendar .bdt-event-item .bdt-ps-slide-img' => 'background-position: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-event-calendar .bdt-event-item .bdt-ps-slide-img' => 'background-attachment: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-event-calendar .bdt-event-item .bdt-ps-slide-img' => 'background-repeat: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-event-calendar .bdt-event-item .bdt-ps-slide-img' => 'background-size: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-event-calendar .bdt-event-title' => 'color: {{VALUE}}; -webkit-text-stroke-color: {{VALUE}};',
				],
			]
		);
	...
	public function render_image() {
		...
		<div class="bdt-event-image">
			<div class="bdt-ps-slide-img" style="background-image: url('<?php echo wp_get_attachment_image_url(get_post_thumbnail_id(), $settings['image_size']); ?>')"></div>
		</div>
	...
	public function render_date() {
		...
		<span class="bdt-event-date">
			<a href="#" title="<?php esc_html_e('Start Date:', 'bdthemes-prime-slider'); echo esc_html($start_datetime); ?>  - <?php esc_html_e('End Date:', 'bdthemes-prime-slider'); echo esc_html($end_datetime); ?>"> 
		...
		<div class="bdt-event-meta">
			...
			<?php if ('yes' == $settings['show_buy_button']) : ?>
				<div class="bdt-event-price">
					...
					<?php endif; ?>
						<span><?php esc_html_e('Buy Ticket Online', 'bdthemes-prime-slider'); ?></span>
					<?php if ( '' !== $settings['button_link']['url'] ) : ?>
					</a>
					<?php endif; ?>
				</div>
			...
			<?php if ( $address ) : ?>
			    <div class="bdt-address-website-icon">
					<a href="javacript:void(0);" bdt-tooltip="<?php echo esc_html( tribe_get_full_address() ); ?>">
						<span class="eicon-map-pin"></span>
						<span><?php esc_html_e(' View Location', 'bdthemes-prime-slider'); ?></span>
					</a>
			    </div>
			<?php endif; ?>
	...
	public function render_header() {
		...
		$this->add_render_attribute( 'event-slider', 'class', 'swiper-container' );

		$this->add_render_attribute('event-slider-wrapper', 'class', 'swiper-wrapper');

		?>
		<div <?php $this->print_render_attribute_string( 'slider' ); ?>>
			<div <?php $this->print_render_attribute_string( 'event-slider' ); ?>>
			...
			<div class="bdt-arrows-dots-container bdt-slidenav-container ">
				...
				<div class="bdt-flex bdt-flex-middle">
					<div class="<?php echo esc_attr( $hide_arrows ); ?>">
						<a href="" class="bdt-navigation-prev bdt-slidenav-previous bdt-icon bdt-slidenav"><i class="ps-wi-arrow-left-5"></i></a>	
					</div>
					...
					<div class="<?php echo esc_attr( $hide_arrows ); ?>">
						<a href="" class="bdt-navigation-next bdt-slidenav-next bdt-icon bdt-slidenav"><i class="ps-wi-arrow-right-5"></i></a>	
					</div>
		...
		<div class="bdt-event-item swiper-slide">
			...
			<div class="bdt-default-shape">
                <div class="bdt-shape-1">
					<img src="<?php echo BDTPS_ASSETS_URL; ?>images/shape/shape-1.svg" alt="Shape Image">
                </div>

                <div class="bdt-shape-2 rotateme">
					<img src="<?php echo BDTPS_ASSETS_URL; ?>images/shape/shape-2.svg" alt="Shape Image">
                </div>

                <div class="bdt-shape-3">
					<img src="<?php echo BDTPS_ASSETS_URL; ?>images/shape/shape-3.svg" alt="Shape Image">
                </div>

                <div class="bdt-shape-4">
					<img src="<?php echo BDTPS_ASSETS_URL; ?>images/shape/shape-4.svg" alt="Shape Image">
                </div>

                <div class="bdt-shape-5">
					<img src="<?php echo BDTPS_ASSETS_URL; ?>images/shape/shape-5.svg" alt="Shape Image">
                </div>
