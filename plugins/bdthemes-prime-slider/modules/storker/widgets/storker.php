...
// Exit if accessed directly
    ...
    class Storker extends Widget_Base {
        ...
        private function register_query_section_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bdt-prime-slider-storker .bdt-image-wrap::before' => 'background: {{VALUE}};',
                    ],
                ]
            );
        ...
        public function render_image($image_id, $size) {
            ...
            ?>
            <img class="bdt-storker-img swiper-lazy" src="<?php echo esc_url($image_src); ?>" alt="<?php echo esc_attr(get_the_title()); ?>">
            <?php
        }
