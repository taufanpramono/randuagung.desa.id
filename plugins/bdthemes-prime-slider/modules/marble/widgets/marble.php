<?php
    ...
    namespace PrimeSlider\Modules\Marble\Widgets;
...
// Exit if accessed directly
    ...
    class Marble extends Widget_Base {
        ...
        public function get_icon() {
            return 'bdt-widget-icon ps-wi-marble bdt-new';
        }
        ...
        private function register_query_section_controls() {
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bdt-marble-slider .swiper-container' => 'padding: {{SIZE}}{{UNIT}} 0;',
                    ],
                ]
            );
        ...
        public function render_slider_item($post_id, $image_size, $slide_index) {
            ...
            <div <?php echo $this->get_render_attribute_string('slider-item'); ?>>
                <div class="bdt-img-wrap">
                    ...
                    <div class="bdt-counter"><?php printf("%02d", $slide_index); ?></div>
                    <?php endif; ?>
                </div>
