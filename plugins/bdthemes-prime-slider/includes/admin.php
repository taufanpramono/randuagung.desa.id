    ...
    class Admin {
        ...
        public function __construct() {
            ...
            if ( ! bdt_ps()->is__premium_only() ) {
                if ( ps_is_giveaway_notice_enabled() ) {
                    add_action( 'admin_notices', [$this, 'rate_the_prime_slider'] );
                }
            }
        }
        ...
        public function rate_the_prime_slider() {
            
            Notices::add_notice(
                [
                    'id'               => 'rate-the-prime-slider',
                    'type'             => 'success',
                    'dismissible'      => true,
                    'dismissible-time' => 1209600,
                    'message'          => __( '<b>Win Prime Slider Pro Lifetime License</b> by giving us an honest review. Please go to <a href="https://wordpress.org/plugins/bdthemes-prime-slider-lite/">Prime Slider</a> WordPress repository and submit your review. We will select one random user from the review page every month. When you complete your review just fill-up <a href="https://bdthemes.com/giveaway-form/">this form</a> to join our giveaway program.', 'bdthemes-prime-slider' ),
                ]
            );
        }
