		...
		?>
			<div class="bdt-prime-slider">
				<div class="bdt-header-wrapper bdt-position-top">
					<header <?php $this->parent->print_render_attribute_string('header'); ?>>
				...
				<div class="bdt-position-relative bdt-visible-toggle" <?php $this->parent->print_render_attribute_string('slideshow'); ?>>
