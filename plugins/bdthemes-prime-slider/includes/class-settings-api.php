        ...
        function callback_checkbox( $args ) {
            ...
            $html .= '<div class="ps-option-item-inner">';
                ...
                if ($plugin_name and $plugin_path) {
                    ...
                    $html  .= sprintf( '<input type="checkbox" class="checkbox" id="bdt_ep_%1$s[%2$s]" name="%1$s[%2$s]" value="'.$default_value.'" %3$s %4$s />', $args['section'], $args['id'], checked( $value, $default_value, false ), $pro_widget );
