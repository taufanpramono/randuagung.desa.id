									...
									<div class="bdt-prime-slider-logo bdt-flex bdt-flex-middle">
										...
										<?php if ('yes' == $settings['show_offcanvas']) : ?>
											<?php if ('left' == $settings['offcanvas_button_align'] and 'general' == $skin_name) : ?>
												<div <?php $this->print_render_attribute_string('hide_offcanvas'); ?>>
					...
					<div class="bdt-prime-slider-desc">
						...
						<?php if ($slide_content['sub_title'] && ('yes' == $settings['show_sub_title'])) : ?>
							<div class="bdt-sub-title">
								<h4 class="bdt-ps-sub-title" <?php echo $parallax_sub_title; ?>>
						...
						<?php if ($slide_content['title'] && ('yes' == $settings['show_title'])) : ?>
							<div class="bdt-main-title" <?php echo $parallax_title; ?>>
						...
						<?php if ( $slide_content['excerpt'] && ('yes' == $settings['show_excerpt']) && ('yes' == $settings['alter_btn_excerpt']) ) : ?>
							<div class="bdt-slider-excerpt" <?php echo $parallax_inner_excerpt; ?>>
