...
namespace PrimeSlider\Modules\Custom\Widgets;
	...
	public function render_navigation_arrows()
	{
		...
		?>
			...
			<?php if ($settings['show_navigation_arrows']) : ?>
				...
				<a <?php $this->print_render_attribute_string('prev_position'); ?> href="#" bdt-slideshow-item="previous">
	...
	public function render_item_content($slide_content)
	{
		...
		<?php else : ?>
			<div class="bdt-alert-warning" bdt-alert>
				...
				<p><?php esc_html_e( 'Please Select Template From Sliders Section. ', 'bdthemes-prime-slider' ); ?></p>
			</div>
		<?php endif; ?>
