...
class dragon extends Widget_Base {
	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			'show_blur_effect',
			[
				'label'   => esc_html__('Show Blur Effect', 'bdthemes-prime-slider') . BDTPS_NC,
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
				...
				<div class="bdt-prime-slider-content">
					...
					<?php if ($slide_content['title'] && ('yes' == $settings['show_title'])) : ?>
						<div class="bdt-main-title">
							<<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?> class="bdt-title-tag"  bdt-slideshow-parallax="x: 200,-200; opacity: 1,1,0">
