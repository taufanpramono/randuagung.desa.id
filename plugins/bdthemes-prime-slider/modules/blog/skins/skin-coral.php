...
class Skin_Coral extends Elementor_Skin_Base {
    ...
    public function render_navigation_arrows() {
      ...
      <div class="bdt-ps-thumbnav">
          ...
          while ( $wp_query->have_posts() ) {
            ...
            <li class="bdt-slide-counter" bdt-slideshow-item="<?php echo(($slide_index - 2) == -1 ) ? ($total_slide - 2) : $slide_index - 2 ?>"
    ...
    public function render_scroll_button_text() {
        ...
        ?>
      <span
          bdt-scrollspy="cls: bdt-animation-slide-right; repeat: true" <?php $this->parent->print_render_attribute_string('content-wrapper'); ?>>
    ...
    public function rendar_thumb_image($size = 'thumbnail') {
        ...
        <div class="bdt-ps-slide-img" style="background-image: url('<?php echo esc_url($image_src); ?>')"></div>
