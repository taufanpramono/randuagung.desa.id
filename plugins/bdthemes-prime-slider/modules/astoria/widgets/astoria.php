...
class Astoria extends Widget_Base {
	...
	public function get_icon() {
		return 'bdt-widget-icon ps-wi-astoria bdt-new';
	}
	...
	private function register_query_section_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-astoria-slider .bdt-slide-img' => 'background-position: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-astoria-slider .bdt-slide-img' => 'background-attachment: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-astoria-slider .bdt-slide-img' => 'background-repeat: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-astoria-slider .bdt-slide-img' => 'background-size: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
	...
	public function render_social_link($position = 'right', $class = []) {
		...
		$this->add_render_attribute('social-icon', 'class', 'bdt-social-icon');
	...
	public function render_scroll_button() {
		...
		$this->add_render_attribute('bdt-scroll-down', 'class', ['bdt-ps-button bdt-scroll-down']);
		...
		<div class="bdt-btn-wrap">
			<a <?php $this->print_render_attribute_string('slider-button'); ?>>
				<svg class="textcircle" viewBox="0 0 500 500">
				  ...
				  /></defs>
				  <text><textPath xlink:href="#textcircle" aria-label="Projects & client work 2020" textLength="900"><?php echo wp_kses($content['slide_button_text'], prime_slider_allow_tags('title')); ?></textPath></text>
			  	</svg>
			</a>
		</div>
		<?php endif;
