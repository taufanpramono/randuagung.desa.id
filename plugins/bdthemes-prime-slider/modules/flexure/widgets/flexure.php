<?php
namespace PrimeSlider\Modules\Flexure\Widgets;
...
class Flexure extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'dynamic'    => [ 'active' => true ],
				'default'    => __( 'Box Content', 'bdthemes-prime-slider' ),
			]
		);	
		...
		$repeater->add_control(
			...
			[
				...
				'dynamic' => [ 'active' => true ],
				'default' => [
					'url' => BDTPS_ASSETS_URL . 'images/slide/item-'.rand(1,6).'.jpg',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'ps_flexure_title'   	  => __( 'Flexure One', 'bdthemes-prime-slider' ),
						'ps_flexure_content' 	  => __( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni illo ea animi.', 'bdthemes-prime-slider' ),
						'slide_image' => ['url' => BDTPS_ASSETS_URL . 'images/gallery/img-1.svg']
					],
					[
						'ps_flexure_title'   => __( 'Flexure Two', 'bdthemes-prime-slider' ),
						'ps_flexure_content' => __( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni illo ea animi.', 'bdthemes-prime-slider' ),
						'slide_image' => ['url' => BDTPS_ASSETS_URL . 'images/gallery/img-2.svg']
					],
					[
						'ps_flexure_title'   => __( 'Flexure Three', 'bdthemes-prime-slider' ),
						'ps_flexure_content' => __( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni illo ea animi.', 'bdthemes-prime-slider' ),
						'slide_image' => ['url' => BDTPS_ASSETS_URL . 'images/gallery/img-3.svg']
					],
					[
						'ps_flexure_title'   => __( 'Flexure Four', 'bdthemes-prime-slider' ),
						'ps_flexure_content' => __( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni illo ea animi.', 'bdthemes-prime-slider' ),
						'slide_image' => ['url' => BDTPS_ASSETS_URL . 'images/gallery/img-1.svg']
					],
					[
						'ps_flexure_title'   => __( 'Flexure Five', 'bdthemes-prime-slider' ),
						'ps_flexure_content' => __( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni illo ea animi.', 'bdthemes-prime-slider' ),
						'slide_image' => ['url' => BDTPS_ASSETS_URL . 'images/gallery/img-2.svg']
					],
					[
						'ps_flexure_title'   => __( 'Flexure Six', 'bdthemes-prime-slider' ),
						'ps_flexure_content' => __( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni illo ea animi.', 'bdthemes-prime-slider' ),
						'slide_image' => ['url' => BDTPS_ASSETS_URL . 'images/gallery/img-3.svg']
					],
				],
		...
		$this->add_group_control(
			...
			[
				...
				'exclude'      => [ 'custom' ],
				'default'      => 'full',
				'prefix_class' => 'bdt-prime-slider-flexure--thumbnail-size-',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider-flexure .bdt-ps-flexure-image' => 'background-position: {{VALUE}};',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider-flexure .bdt-ps-flexure-image' => 'background-attachment: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider-flexure .bdt-ps-flexure-image' => 'background-repeat: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider-flexure .bdt-ps-flexure-image' => 'background-size: {{VALUE}};',
				],
				'condition' => [
					'background_image_toggle' => 'yes'
				],
		...
		$this->add_control(
            'title_position',
            [
                'label'   => __('Title Position', 'bdthemes-prime-slider') . BDTPS_NC,
                'type'    => Controls_Manager::SELECT,
                'default' => 'center',
                'options' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Vertical Offset(%)', 'bdthemes-prime-slider' ) . BDTPS_NC,
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'nav_arrows_icon',
			[
				'label'   => esc_html__( 'Arrows Icon', 'bdthemes-element-pack' ) . BDTPS_NC,
				'type'    => Controls_Manager::SELECT,
				'default' => '0',
				'options' => [
	...
	public function render_slider_pagination() {
        ...
        <?php if ($settings['show_slider_pagination']) : ?>
            ...
            <ul class="bdt-ps-dotnav bdt-position-bottom-left">
                <?php $slide_index = 1; foreach ( $settings['ps_slider'] as $slide ) : ?>
                    <li bdt-slider-item="<?php echo ($slide_index - 1); ?>" data-label="<?php echo str_pad( $slide_index, 2, '0', STR_PAD_LEFT); ?>" ><a href="#"><?php echo str_pad( $slide_index, 2, '0', STR_PAD_LEFT); ?></a></li>
	...
	public function box_items() {
		...
		$this->add_render_attribute('box-settings', 'class', 'bdt-child-width-1-' . esc_attr($settings['columns_mobile']));
		$this->add_render_attribute('box-settings', 'class', 'bdt-child-width-1-' . esc_attr($settings['columns_tablet']) .'@s');
		$this->add_render_attribute('box-settings', 'class', 'bdt-child-width-1-' . esc_attr($settings['columns']) .'@m');
		...
		<div <?php echo ( $this->get_render_attribute_string( 'slider-settings' ) ); ?>>
			<div <?php $this->print_render_attribute_string( 'box-settings' ); ?>>
				...
				<?php $slide_index = 1; foreach ( $settings['ps_slider'] as $index => $item ) :
					...
					?>
					<div>
						<div <?php echo ( $this->get_render_attribute_string( 'ps-flexure-item' ) ); ?> data-id="<?php echo esc_attr($tab_id); ?>">

						<div class="bdt-ps-flexure-description bdt-position-small bdt-position-<?php echo esc_attr($settings['title_position']) ?>">

								<?php if ( $item['ps_flexure_title'] && ( 'yes' == $settings['show_title'] ) ) : ?>
									<<?php echo Utils::get_valid_html_tag($settings['title_tags']); ?> <?php $this->print_render_attribute_string('bdt-ps-flexure-title'); ?> data-label="<?php echo str_pad( $tab_count, 2, '0', STR_PAD_LEFT); ?>">
				...
				<div id="<?php echo esc_attr($tab_id); ?>" <?php echo ( $this->get_render_attribute_string( 'ps-flexure-content' ) ); ?>>
					...
					<?php if ( $item['ps_flexure_content'] && ( 'yes' == $settings['show_content'] ) ) : ?>
						<div class="bdt-ps-flexure-text-wrapper">
							<span class="bdt-custom-divider" data-label="<?php echo str_pad( $tab_count, 2, '0', STR_PAD_LEFT); ?>"></span>
							<div class="bdt-ps-flexure-text">
